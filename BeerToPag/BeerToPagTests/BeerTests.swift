...
class BeerTests: XCTestCase {
    ...
    func test_Init_TakeNonOptionalsInformations() {
        let beer = Beer(id: 1,
                        name: "Name",
                        tagline: nil,
                        description: nil,
    ...
    func test_Init_TakeCompleteInformations() {
        let beer = Beer(id: 1,
                        name: "Name",
                        tagline: "Tagline",
    ...
    func test_Init_WhenGivenInformations_SetInformations() {
        let beer = Beer(id: 1,
                        name: "Name",
                        tagline: "Tagline",
                        description: "Description",
                        ...
                        abv: 6.0,
                        ibu: 60)
        XCTAssertEqual(beer.id, 1, "should set id")
